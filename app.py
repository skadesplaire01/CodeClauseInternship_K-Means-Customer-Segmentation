...
# Stylish title 
st.markdown(
    "<h2 style='text-align: center;'>🛍️ Customer Segmentation using "
    "<span style='color:#F63366;'>K-Means</span></h2>",
...
if uploaded_file is not None:
    ...
    st.markdown("<h2 style='color:gray;'>📂 Please upload a CSV file using the sidebar to begin...</h2>", unsafe_allow_html=True)
